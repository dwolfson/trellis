...
| ~~take architecture results into Curate~~ | trellis-survey-flows-59 (backend) + trellis-arch-ui-65 (UI, materializer) | **decided (accept/reject/retype) and built** — `6f3afeb` (S2, backend) `2a22c99` `f34d3c5` (S1, UI + materializer) |
